...
const plugins = [
  ...
  },
  {
    ...
    options: {
      ...
      customer_reset_password_template: process.env.SENDGRID_CUSTOMER_RESET_PASSWORD_TEMPLATE,
      customer_confirmation_template: process.env.SENDGRID_CUSTOMER_CONFIRMATION_TEMPLATE,
