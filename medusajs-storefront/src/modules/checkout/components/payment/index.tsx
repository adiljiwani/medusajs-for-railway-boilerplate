  ...
  return (
    <div className="bg-white">
      ...
      <Text className="txt-medium-plus text-ui-fg-base mb-1">
          After your order is placed, you will recieve an invoice for items available to fulfill with the payment amount. Your goods will only be shipped after payment is received.
          <br />
          <br />
        </Text>
